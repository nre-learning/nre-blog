...
We are very excited about this - mobile support is something we've wanted to have for a while and are very excited to finally be able to offer it. We would love to [hear your feedback](https://twitter.com/nrelabs) about your experience using the site on mobile.
...
- The new site, as well as the revised documentation, is much simpler and consolidated. Finding out how to contribute, what to expect from a release perspective, and how to get in touch, is frankly plastered all over the site now. The new documentation is written specifically with curriculum contributors in mind, and is simpler and easier to follow. We will continue to invest into making this the expected experience for our documentation.
